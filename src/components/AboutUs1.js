			...
			<div className="container">
				...
				<div className="about-us-1__content">
					<div className="wrap-content">
						...
						<h2 className="component-title">Listen to a persona lized mix of tracks</h2>
						<ul className="about-us-1__content__list">
							<li>
								<span>01</span>
								<p className="text">Reduce unnecessary spend with real time insights into every penny spent.</p>
							</li>
							<li>
								<span>02</span>
								<p className="text">Reduce unnecessary spend with real time insights into every penny spent.</p>
