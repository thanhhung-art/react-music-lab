	...
	return (
		<section className="features">
			<div className="container">
				...
				<p className="features__text text">Utrust is a seamless integration that gives e-commerce businesses the power to accept digital currencies - and get all the benefits you can’t with just traditional payment methods.</p>
