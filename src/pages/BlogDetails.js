			...
			<div className="container wrap-content blog-details">
				<div className="col__post">
					<Post  image={image1} 
						   ...
						   comments={3}
					/>
					<p className="text__small">MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction of the camp price. However, who has the willpower
					</p>
					<p className="text__small">MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction of the camp price. However, who has the willpower
					</p>
					...
					<div className="author">
						...
						<div className="author__info">
							...
							<p className="text__small">Second divided from form fish beast made. Every of seas all gathered use saying you're, he our dominion twon Second divided from</p>
						</div>
					</div>
					<div className="wrap__comments__component">
						<h3>03 comments</h3>
						<div className="wrap__comments">
							<SomeOne image={comment1}
									 comment={"Multiply sea night grass fourth day sea lesser rule open subdue female fill which them Blessed, give fill lesser bearing multiply sea night grass fourth day sea lesser"}
							    	 name="Emily Blunt"
							    	 time="December 4, 2017 at 3:12 pm"
							/>
							<SomeOne image={comment2}
									 comment={"Multiply sea night grass fourth day sea lesser rule open subdue female fill which them Blessed, give fill lesser bearing multiply sea night grass fourth day sea lesser"}
							    	 name="Emily Blunt"
							    	 time="December 4, 2017 at 3:12 pm"
							/>
							<SomeOne image={comment3}
									 comment={"Multiply sea night grass fourth day sea lesser rule open subdue female fill which them Blessed, give fill lesser bearing multiply sea night grass fourth day sea lesser"}
							    	 name="Emily Blunt"
							    	 time="December 4, 2017 at 3:12 pm"
							/>
					...
					<div className="post__comment">
						<h3>Leave a Reply</h3>
						<Form placeholderComment="Write Comment"
