			...
			<div className="container elements">
				...
				<div className="block-quotes component">
					...
					<div className="quote__wrap">
						<div className="quote__inner">
							<p className="quote__text">“Recently, the US Federal government banned online casinos from operating in America by making it illegal to transfer money to them through any US bank or payment system. As a result of this law, most of the popular online casino networks such as Party Gaming and PlayTech left the United States. Overnight, online casino players found themselves being chased by the Federal government. But, after a fortnight, the online casino industry came up with a solution and new online casinos started taking root. These began to operate under a different business umbrella, and by doing that, rendered the transfer of money to and from them legal. A major part of this was enlisting electronic banking systems that would accept this new clarification and start doing business with me. Listed in this article are the electronic banking”</p>
						</div>
					</div>
				</div>
				<div className="table component">
					...
					<table>
						...
						<thead>
							<tr>
								<th><h4>#</h4></th>
								<th className="countries__header"><h4>COUNTRIES</h4></th>
								<th><h4>VISITS</h4></th>
								<th className="col__percent"><h4>PRECENTAGES</h4></th>
							</tr>
						</thead>
						<tbody>
							<tr>
				...
				<div className="gallery component">
					...
					<div className="gallery__images">
						<div className="flex-3"><img src={child1} alt="childs"/></div>
						<div className="flex-3"><img src={child2} alt="childs"/></div>
						<div className="flex-3"><img src={child3} alt="childs"/></div>
						<div className="flex-2"><img src={child4} alt="childs"/></div>
						<div className="flex-2"><img src={child5} alt="childs"/></div>
						<div className="flex-3"><img src={child6} alt="childs"/></div>
						<div className="flex-3"><img src={child7} alt="childs"/></div>
						<div className="flex-3"><img src={child8} alt="childs"/></div>
					</div>
				</div>
				<div className="lists component">
					<div className="col col-1 image-gallery">
						...
						<ul>
							<li><h2>This is header 01</h2></li>
							<li><h3>This is header 02</h3></li>
							<li><h4>This is header 03</h4></li>
							<li><h5>This is header 04</h5></li>
							<li><h6>This is header 05</h6></li>
							<li><h6>This is header 06</h6></li>
						</ul>
					</div>
					<div className="col col-2 unordered-list">
						...
						<ul>
							<li><p>Fta Keys</p></li>
							<li><p>For Women Only Your Computer Usage</p></li>
							<li>
								...
								<ul>
									<li>
									    ...
									    <ul>
									    	<li><p>Protective Preventative Maintenance</p></li>
									    </ul>
									</li>
								</ul>
							</li>
							<li><p>Dealing With Technical Support 10 Useful Tips</p></li>
							<li><p>Make Myspace Your Best Designed Space</p></li>
							<li><p>Cleaning And Organizing Your Computer</p></li>
						</ul>
					</div>
				...
				<div className="form-elements">
					<div className="form-elements__col-1">
						...
						<form action="" autocomplete="on">
							...
							<input className="input-color" type="text" placeholder="Primary Color" />
							<input className="input-color" type="text" placeholder="Accent color" />
							<input className="input-color" type="text" placeholder="Secondary color" />
						</form>
					</div>
	...
	return (
		<div className="wrap_buttons">
			<div className="row__1">
				...
				<button className={`btn ${props.shape} btn__primary__gray`}>primary</button>
			...
			<div className="row__2">
				<button className={`btn ${props.shape} btn__reverse__default`}>default</button>
				<button className={`btn ${props.shape} btn__reverse__primary__gray`}>primary</button>
				<button className={`btn ${props.shape} btn__reverse__success`}>Success</button>
